...
@media all and (max-width: 599px) and (min-width: 320px) {
    ...
    <body> 
        ...
        <div class="container">
			...
			<h2 class="logindesc">Below you will find a list of the current schedule and links to add, update and delete them.</h2>
...
<nav class="mb-1 navbar navbar-expand-lg navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent-555">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="schedule.php">Insert New Schedule Item</a>
      </li>
    </ul>
