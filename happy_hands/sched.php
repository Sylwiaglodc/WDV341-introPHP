...
<?php 
		...
		?>		
				<div class="productBlock">
					<p class="productName"><strong>Schedule name:<br></strong><?php echo $row['schedule_name']; ?></p>	
					<p class="productDesc"><strong>Schedule time:<br></strong><?php echo $row['schedule_time']; ?></p>
					<p class="productPrice"><strong>Schedule description:<br></strong><?php echo $row['schedule_desc']; ?></p>
				</div>
				<?php
			}
		?>	
